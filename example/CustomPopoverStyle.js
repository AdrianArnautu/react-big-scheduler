    ...
    render(){
        ...
        return (
            <div>
                <Nav />
                <div>
                    <h3 style={{textAlign: 'center'}}>Custom popover style example<ViewSrcCode srcCodeUrl="https://github.com/AdrianArnautu/react-resource-scheduler/blob/master/example/CustomPopoverStyle.js" /></h3>
