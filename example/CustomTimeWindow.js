    ...
    render(){
        ...
        return (
            <div>
                <Nav />
                <div>
                    <h3 style={{textAlign: 'center'}}>Custom time window<ViewSrcCode srcCodeUrl="https://github.com/AdrianArnautu/react-resource-scheduler/blob/master/example/CustomTimeWindow.js" /></h3>
