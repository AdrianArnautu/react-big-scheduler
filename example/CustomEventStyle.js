    ...
    render(){
        ...
        return (
            <div>
                <Nav />
                <div>
                    <h3 style={{textAlign: 'center'}}>Custom event style<ViewSrcCode srcCodeUrl="https://github.com/AdrianArnautu/react-resource-scheduler/blob/master/example/CustomEventStyle.js" /></h3>
