...
export default class SchedulerData {
    ...
    _createHeaders() {
        ...
        if (this.showAgenda || this.viewType === ViewTypes.Search){
    ...
    _createInitRenderData(isEventPerspective, eventGroups, resources, headers) {
        ...
        slots.forEach((slot) => {
            ...
            let slotRenderData = {
                ...
                customRowHeight: slot.rowHeight ? slot.rowHeight : undefined,
    ...
    _getSpan(startTime, endTime, headers){
        if (this.showAgenda || this.viewType === ViewTypes.Search) return 1;
                ...
                resourceEvents.headerItems.forEach((header, index) => {
                    ...
                    if (headerEnd > eventStart && headerStart < eventEnd) {
                        ...
                        if (header.count > resourceEvents.rowMaxCount) {
                            ...
                            if (resourceEvents.customRowHeight !== undefined) {
                                resourceEvents.rowHeight = resourceEvents.customRowHeight;
                            }
                        }
